...
--     0022 ci-dessous rajoute les colonnes rdv_* (superset). Sur re-run, la vue
...
--  des devis/factures). Une ligne par entité. Écriture admin, lecture par entité.
-- ============================================================================
...
-- ============================================================================
--  0023 — modeles_email : bibliothèque de relances éditable (+ lien_avis).
--  Lecture par entité (tous rôles op), écriture admin. Seed FR (11). Aucun MA.
-- ============================================================================
...
alter table parametres_entreprise add column if not exists lien_avis text;
